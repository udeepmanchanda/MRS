...
import com.example.mrs.SearchDoctorByAdmin;
...
public class CustomAdapterSearchDoctorByAdmin extends ArrayAdapter<DoctorPOJO> {
	...
	public CustomAdapterSearchDoctorByAdmin(Context context, int resource,
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		convertView.setOnLongClickListener(new OnLongClickListener() {
			...
			public boolean onLongClick(View v) {
				...
				((SearchDoctorByAdmin) mContext).showAlertForDoctor(doctorList.get(position).getDoctorId());
