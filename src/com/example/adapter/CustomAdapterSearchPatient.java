...
import com.example.mrs.EditPatientDetails;
...
public class CustomAdapterSearchPatient extends ArrayAdapter<PatientPOJO> {
	...
	public CustomAdapterSearchPatient(Context context, int resource,
	...
	//	holder.lName.setText(listItem.getlName());
		...
		convertView.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				Intent intent;
				if ("Manager".equals(ParseUser.getCurrentUser().getString("Role"))) {
					intent = new Intent(mContext, EditPatientDetails.class);
