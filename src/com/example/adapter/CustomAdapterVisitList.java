...
public class CustomAdapterVisitList extends ArrayAdapter<VisitDetailsPOJO> {
	...
	public CustomAdapterVisitList(Context context, int resource,
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        // inflate the layout
            ...
            holder.doctorName = (TextView) convertView.findViewById(R.id.textView1);
        ...
        holder.doctorName.setText(listItem.getDoctorName());
	...
	static class ViewHolder {
		...
		private TextView doctorName,appointmentDate,appointmentId ;
