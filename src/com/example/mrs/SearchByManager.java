...
import com.example.adapter.CustomAdapterSearchPatient;
...
public class SearchByManager extends Activity  {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		query.findInBackground(new FindCallback<ParseObject>() {
			...
			public void done(List<ParseObject> objects, ParseException e) {
				if(e == null && objects != null){
					...
					adapter = new CustomAdapterSearchPatient(SearchByManager.this, R.layout.search_patient_list, aList);
		...
		searchText.addTextChangedListener(new TextWatcher() {
		    ...
		    public void onTextChanged(CharSequence cs, int arg1, int arg2, int arg3) {
				...
				((CustomAdapterSearchPatient) adapter).filter(text);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.to_do_manager, menu);
		return true;
	}
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		if (id == R.id.action_add_operator) {

			 Intent intent = new Intent(SearchByManager.this, AddOperatorActivity.class);
			 startActivity(intent);
			 
			return true;
		}else if (id == R.id.action_add_doctor) {

			 Intent intent = new Intent(SearchByManager.this, AddDoctorActivity.class);
			 startActivity(intent);
			 
			return true;
		}else if (id == R.id.action_search_doctor) {
			 Intent intent = new Intent(SearchByManager.this, SearchDoctorByManager.class);
			 startActivity(intent);
			 finish();
			return true;
		}else if (id == R.id.action_logout) {
			ParseUser.logOut();
			 Intent intent = new Intent(SearchByManager.this, LoginActivity.class);
			 startActivity(intent);
			 finish();
			return true;
		}
